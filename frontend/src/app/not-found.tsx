    ...
    <main className="min-h-screen bg-[var(--color-surface-0)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl relative z-10 text-center flex flex-col items-center">
        <motion.div
          ...
          className="w-24 h-24 rounded-3xl bg-red-500/10 border border-red-500/20 flex items-center justify-center mb-8 shadow-[0_0_50px_rgba(239,68,68,0.1)]"
        >
        ...
        <motion.h1
          ...
          className="font-display font-bold text-8xl md:text-9xl text-white tracking-tighter mb-4"
        >
          404
        </motion.h1>
